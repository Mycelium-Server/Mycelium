...
ClientboundPlayerInfo::AddPlayerAction::AddPlayerAction
    (const PlayerData& data, const std::vector<Property>& properties)
...
void ClientboundPlayerInfo::AddPlayerAction::construct
    (const PlayerData& data, const std::vector<Property>& props) {
    name = data.name;
    properties = props;
...
ClientboundPlayerInfo::UpdatePlayerGamemode::UpdatePlayerGamemode(const PlayerData& data)
        : PlayerAction(data) {}
ClientboundPlayerInfo::UpdatePlayerGamemode::UpdatePlayerGamemode
    (const uuids::uuid& uuid, const Gamemode& gamemode)
    : PlayerAction(uuid), gamemode(gamemode) {}
...
ClientboundPlayerInfo::UpdatePlayerLatency::UpdatePlayerLatency
    (const uuids::uuid& uuid, int ping)
    : PlayerAction(uuid), ping(ping) {}
...
ClientboundPlayerInfo::UpdatePlayerDisplayName::UpdatePlayerDisplayName(const uuids::uuid& uuid)
        : PlayerAction(uuid) {}
ClientboundPlayerInfo::UpdatePlayerDisplayName::UpdatePlayerDisplayName
    (const uuids::uuid& uuid, std::optional<std::string> displayName)
    : PlayerAction(uuid), displayName(std::move(displayName)) {}
ClientboundPlayerInfo::UpdatePlayerDisplayName::UpdatePlayerDisplayName(const PlayerData& data)
    : PlayerAction(data), displayName(data.entity->getDisplayName()) {}
